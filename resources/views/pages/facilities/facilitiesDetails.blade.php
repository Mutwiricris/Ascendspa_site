...
@section('content')
  ...
  <div id="wrapper">
    ...
    <div class="abs w-80 bottom-10 z-2 w-100">
      ...
      <div class="row">
        ...
        <div class="relative overflow-hidden">
          ...
          <h1 class="fs-120 text-uppercase fs-sm-10vw mb-2 lh-1">Premium Spa Suite</h1>
    ...
    <div class="container">
      ...
      <div class="col-md-8">
        <h3>This well-designed single apartment room offers modern living in a compact space. Ideal for first-time
        buyers, students, or investors, the property features a functional layout, premium finishes, and access to
        on-site amenities.</h3>
  ...
  <footer class="section-dark">
    ...
    <div class="row gx-5 justify-content-center">
      <div class="col-lg-8">
      <div class="text-center">
        <img src="{{asset('images/logo.webp')}}" class="w-200px" alt="">
        <div class="spacer-single"></div>
        <div class="fs-16">
