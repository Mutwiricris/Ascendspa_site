...
@section('content')
    ...
    <div class="abs w-80 bottom-10 z-2 w-100">
      ...
      <div class="row">
        ...
        <div class="relative overflow-hidden">
          ...
          <h1 class="fs-120 text-uppercase fs-sm-10vw mb-2 lh-1">Service Details</h1>
          <h3>Professional Spa & Wellness Services</h3>
          </div>
        </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="col-md-8">
        <h3>Discover our comprehensive range of spa and wellness services designed to rejuvenate your body and mind. From relaxing massages to revitalizing facials, each treatment is crafted to provide you with the ultimate wellness experience.</h3>
    ...
    <div class="container-fluid">
      <div class="row">
      <div class="col-lg-12">
        <div class="owl-custom-nav menu-float" data-target="#service-carousel">
        <a class="btn-next"></a>
        <a class="btn-prev"></a>

        <div id="service-carousel" class="owl-2-cols-center owl-carousel owl-theme">
          <!-- item begin -->
          <div class="item">
          <div class="relative">
              ...
              <div class="row g-4">
                        ...
                        <div class="hover overflow-hidden relative text-light text-center wow zoomIn" data-wow-delay=".0s">
                            ...
                            <div class="abs z-2 bottom-0 p-30 w-100 text-center hover-op-0">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h3 class="mb-0">Relaxation Massage</h3>
                                    <div>From $65</div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="hover overflow-hidden relative text-light text-center wow zoomIn" data-wow-delay=".0s">
                            ...
                            <div class="abs z-2 bottom-0 p-30 w-100 text-center hover-op-0">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h3 class="mb-0">Body Scrub Treatment</h3>
                                    <div>From $55</div>
                                </div>
                            </div>
                            <div class="gradient-edge-bottom abs w-100 h-40 bottom-0"></div>
    ...
    <div class="container">
      ...
      <div class="col-lg-4">
        ...
        <div class="relative rounded-1 overflow-hidden">
          ...
          <div class="w-60">Relaxation Massage</div>
          ...
          <div class="d-flex bg-light px-4 py-2">
          <div class="w-60">Body Scrub Treatment</div>
          ...
          <div class="d-flex px-4 py-2">
          <div class="w-60">Detox Body Wrap</div>
    ...
    <div class="container">
      ...
      <div class="col-lg-4 relative z-3">
        ...
        <h2 class="wow fadeInUp" data-wow-delay=".2s">Premium Spa Experience</h2>
        </div>
      </div>
    ...
    <div class="container relative z-2">
      ...
      <div class="col-lg-6 text-center">
        ...
        <h2 class="wow fadeInUp" data-wow-delay=".2s">Schedule Your Wellness Experience</h2>
      </div>
      </div>
      ...
      <div class="col-md-4">
        ...
        <div class="mt-3">
          <h4 class="mb-0">Amanda Thompson</h4>
          <div class="fw-500 id-color">Spa Manager</div>
        </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        ...
        <div class="mt-3">
          <h4 class="mb-0">Rachel Martinez</h4>
          <div class="fw-500 id-color">Senior Therapist</div>
        </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row g-4">
      <div class="col-md-9">
        <h3 class="mb-0 fs-32">Ready to rejuvenate your body and mind?</h3>
      </div>
      <div class="col-lg-3 text-lg-end">
        <a class="btn-main fx-slide btn-line" href="#"><span>Book Now</span></a>
      </div>
      </div>
    </div>
    </section>
