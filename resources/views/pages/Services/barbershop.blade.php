...
@section('content')
    ...
    <div class="abs w-80 bottom-10 z-2 w-100">
      ...
      <div class="row">
        ...
        <div class="relative overflow-hidden">
          ...
          <h1 class="fs-120 text-uppercase fs-sm-10vw mb-2 lh-1">Barbershop Services</h1>
          <h3>Professional Haircuts, Beard Grooming, and Traditional Barbering</h3>
          </div>
        </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="col-md-8">
        <h3>Our barbershop services offer professional grooming treatments for men. From classic haircuts to modern styling, beard trimming to traditional hot towel shaves, we provide comprehensive barbering services in a traditional atmosphere.</h3>
    ...
    <div class="container-fluid">
      <div class="row">
      <div class="col-lg-12">
        <div class="owl-custom-nav menu-float" data-target="#barbershop-carousel">
        <a class="btn-next"></a>
        <a class="btn-prev"></a>

        <div id="barbershop-carousel" class="owl-2-cols-center owl-carousel owl-theme">
          <!-- item begin -->
          <div class="item">
          <div class="relative">
    ...
    <div class="container-fluid relative z-2">
      ...
      <div class="col-md-6">
        ...
        <div class="abs z-2 bottom-0 p-30 w-100 text-center hover-op-0">
          <div class="d-flex justify-content-between align-items-center">
          <h3 class="mb-0">Hot Towel Shave</h3>
          <div>From $45</div>
          </div>
        </div>
        <div class="gradient-edge-bottom abs w-100 h-40 bottom-0"></div>
      ...
      <div class="col-md-6">
        ...
        <div class="abs z-2 bottom-0 p-30 w-100 text-center hover-op-0">
          <div class="d-flex justify-content-between align-items-center">
          <h3 class="mb-0">Mustache Trim</h3>
          <div>From $20</div>
          </div>
        </div>
        <div class="gradient-edge-bottom abs w-100 h-40 bottom-0"></div>
      ...
      <div class="col-md-6">
        ...
        <div class="abs z-2 bottom-0 p-30 w-100 text-center hover-op-0">
          <div class="d-flex justify-content-between align-items-center">
          <h3 class="mb-0">Hair Wash & Style</h3>
          <div>From $30</div>
          </div>
        </div>
        <div class="gradient-edge-bottom abs w-100 h-40 bottom-0"></div>
    ...
    <div class="container">
      ...
      <div class="col-lg-4">
        ...
        <h2 class="wow fadeInUp" data-wow-delay=".4s">Barbershop Services Menu</h2>
        ...
        <div class="relative rounded-1 overflow-hidden">
          ...
          <div class="w-60">Beard Trim</div>
          <div class="w-40 fw-600">$25</div>
          </div>
          <div class="d-flex bg-light px-4 py-2">
          <div class="w-60">Hot Towel Shave</div>
          ...
          <div class="d-flex bg-light px-4 py-2">
          <div class="w-60">Mustache Trim</div>
          <div class="w-40 fw-600">$20</div>
          </div>
          <div class="d-flex px-4 py-2">
          <div class="w-60">Hair Wash & Style</div>
          <div class="w-40 fw-600">$30</div>
          </div>
          <div class="d-flex bg-light px-4 py-2">
          <div class="w-60">Fade Cut</div>
          <div class="w-40 fw-600">$40</div>
          </div>
          <div class="d-flex px-4 py-2">
          ...
          <div class="w-60">Hair Texture Treatment</div>
    ...
    <div class="container">
      ...
      <div class="col-lg-4 relative z-3">
        ...
        <h2 class="wow fadeInUp" data-wow-delay=".2s">Premium Barbershop Services</h2>
        </div>
      </div>
    ...
    <div class="container relative z-2">
      ...
      <div class="col-lg-6 text-center">
        ...
        <h2 class="wow fadeInUp" data-wow-delay=".2s">Schedule Your Barbershop Appointment</h2>
      </div>
      </div>
      ...
      <div class="col-md-4">
        ...
        <div class="mt-3">
          ...
          <div class="fw-500 id-color">Hair Stylist</div>
        </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        ...
        <div class="mt-3">
          ...
          <div class="fw-500 id-color">Senior Barber</div>
        </div>
        </div>
      </div>
      </div>
    ...
    <div class="container">
      <div class="row g-4">
      <div class="col-md-9">
        <h3 class="mb-0 fs-32">Ready to look your best?</h3>
      </div>
